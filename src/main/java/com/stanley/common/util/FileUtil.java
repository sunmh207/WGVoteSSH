...
import com.stanley.common.form.ComparatorField;
import com.stanley.common.form.JTField;

public class FileUtil {
	public static String exportFile(String path, String extention, Blob blobData, boolean delFile) throws Exception {
		try {
