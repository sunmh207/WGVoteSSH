...
import com.stanley.console.domain.CheJian;
import com.stanley.console.domain.LimitIP;
...
*/
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * com.stanley.console.domain.Menu.MODULES) { if
		 * (moduleMenuMap.containsKey(module[0])) {
		 * System.out.println(module[1]);
		 * java.util.List<com.stanley.console.domain.Menu> menuList =
		 * moduleMenuMap.get(module[0]); for (com.stanley.console.domain.Menu
